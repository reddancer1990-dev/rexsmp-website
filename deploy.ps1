...
git add index.html css js img CNAME .nojekyll robots.txt sitemap.xml .well-known deploy.ps1 protect-cloudflare.ps1 PROTECT-NOW.bat DEPLOY-NOW.bat TEBEX-PACKAGES.txt
